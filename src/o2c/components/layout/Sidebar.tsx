...
import { useApp, type View } from "@/o2c/state";
    ...
    <aside className="flex flex-col w-[240px] shrink-0 h-screen bg-white border-r border-divider sticky top-0">
      ...
      <div className="px-5 pt-6 pb-2">
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <div className="text-[14px] font-bold text-ink">Order-to-cash</div>
            <div className="text-[12px] text-mute">Agentic receivables</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-divider flex items-center gap-2.5">
        ...
        <div className="leading-tight flex-1 min-w-0">
          <div className="text-[13px] text-ink truncate">AR controller · Order-to-cash</div>
