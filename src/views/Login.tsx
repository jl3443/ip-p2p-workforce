...
// works on corporate networks that block remote image CDNs.
const HERO_COLUMNS = [
  { label: "Sourcing & Spot-Buy", src: "/hero-people.jpg" },
  { label: "Orders & Fulfillment", src: "/hero-policy.jpg" },
  { label: "Invoices & Suppliers", src: "/hero-talent.jpg" },
];
...
const PERSONA = {
  ...
  capabilities: [
    "One cockpit over 7 agents and the orchestrator",
